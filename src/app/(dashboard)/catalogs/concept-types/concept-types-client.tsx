        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold dark:text-white">Tipos de Concepto</h1>
                        <p className="text-sm text-gray-500">Marcar conceptos como INGRESO o GASTO para importación de presupuestos</p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4">
                <div className="flex items-center gap-4">
                    <label className="text-sm font-medium dark:text-gray-200">Empresa:</label>
                    <select
                ...
                <>
                    ...
                    {showNewForm && (
                        <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                            <h3 className="font-medium mb-4 dark:text-white">Nueva Sobrescritura de Tipo</h3>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
                        {loading ? (
                            ...
                            <div className="p-8 text-center text-gray-500">
                                No hay sobrescrituras configuradas para esta empresa.
                                <br />
                                <span className="text-sm">Los conceptos se tratarán como GASTO por defecto al importar presupuestos.</span>
                            </div>
                        ) : (
            ...
            <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                <h3 className="font-medium text-amber-800 dark:text-amber-200 mb-2">¿Cómo funciona?</h3>
                <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                    <li>• Al importar presupuestos, los conceptos se tratan como <strong>GASTO</strong> por defecto.</li>
                    <li>• Agrega aquí los conceptos que deben ser tratados como <strong>INGRESO</strong>.</li>
                    <li>• El nombre del concepto debe coincidir exactamente con el del archivo Excel (no distingue mayúsculas/minúsculas).</li>
                    <li>• Las sobrescrituras activas se aplican automáticamente durante la importación.</li>
                </ul>
            </div>
        </div>
    );
